...
/**
* Aktywnosc do obslugi listy zadan
* */
public class ToDoList extends Activity {
    ...
    /**
    * Otwieranie listy i pobieranie informacji z bazy danych
    * */
    @Override
    ...
    /**
    * Obsluga przycisku dodawania zadan
    * Dodaje zadania do bazy danych
    * */
    ...
    * */
    ...
    /**
    * Obsluga dlugiego przycisniecia elementu Listy
    * Otwiera sie okno dialogowe gdzie mamy do wyboru ustawienie przypomnienia lub usuniecie notatki
    * */
